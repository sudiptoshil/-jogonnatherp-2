    ...
    <div class="span12">
        ...
        <div class="widget green">
            <div class="widget-title">
                <h4><i class="icon-reorder"></i>Create New Bakery User</h4>
                <span class="tools">
        ...
        <h3 align="center" style="color:green">{{Session::get('message')}}</h3>
            <div class="widget-body">
                <!-- BEGIN FORM-->
            <form action="{{route('save-bakery-user')}}" method="post" class="form-horizontal">
                @csrf
                    <div class="control-group">
                        <label class="control-label">Bakery User Name</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label">Bakery User Email</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label">Bakery User Password</label>
                        <div class="controls">
